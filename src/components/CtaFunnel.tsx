...
export default function CtaFunnel() {
  ...
  const handleNext = () => {
    ...
    if (step === 4 && !prazo) return;
    if (step === 5 && !conhecimento) return;
    setStep(step + 1);
  };
    ...
    <div className="cta-form-card overflow-hidden relative">
      ...
      <div className="hero-form-top pt-4">
        ...
        <div className="hero-form-title">
          ...
          {step === 3 && "Perfil do investidor"}
          {step === 4 && "Prazo para abrir a clínica"}
          {step === 5 && "Já conhece a OdontoCompany?"}
          {step === 6 && "Para onde enviamos o plano?"}
        </div>
        <p className="hero-form-sub">
          ...
          {step === 3 && "Qual perfil mais se encaixa com você?"}
          {step === 4 && "Qual sua expectativa para começar?"}
          {step === 5 && "Nos ajude a personalizar sua experiência."}
          {step === 6 && "Seu plano de negócios personalizado."}
        </p>
      </div>
