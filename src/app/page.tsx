 ...
 <div className="container">
   <div className="flex flex-col md:flex-row items-center justify-between gap-8 pb-6 border-b border-white/10 w-full">
     <div className="footer-logo">
       <img src="https://pub-db8ed4fb33634589a6ce5fb07e85cb46.r2.dev/landingpage_odc_franchising/logo_odontocompany.svg" alt="OdontoCompany" className="h-6 w-auto object-contain opacity-90" />
     </div>
   ...
   <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-6 text-[11px] text-white/45 w-full">
     ...
     <div className="flex items-center gap-2 bg-black/20 px-3.5 py-1.5 rounded-xl border border-white/5">
       ...
       <a href="https://op7.com.br" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity flex items-center">
         <img src="https://pub-db8ed4fb33634589a6ce5fb07e85cb46.r2.dev/logo/op7/logo.svg" alt="OP7" className="h-4.5 w-auto object-contain inline-block" />
       </a>
     </div>
   </div>
 </div>
