...
const steps = [
  { number: "01", color: "#2D7270", title: "Análise e escolha do ponto", body: "Dados de mercado e perfil de consumo." },
  { number: "02", color: "#38B549", title: "Obra e identidade visual", body: "Projeto padrão com fornecedores homologados." },
  { number: "03", color: "#4C8751", title: "Treinamento pré-abertura", body: "Capacitação completa da equipe antes da inauguração." },
  { number: "04", color: "#4C8751", title: "Marketing e captação de pacientes", body: "Campanhas nacionais: digital, TV, rádio e BOT." },
  { number: "05", color: "#38B549", title: "Acompanhamento pós-inauguração", body: "Suporte intensivo na curva de maturação." },
  { number: "06", color: "#2D7270", title: "Tecnologia e gestão contínua", body: "Software de gestão e plataforma Minha OdontoCompany." },
];
      ...
      <div className="roadmap-container">
        ...
        <div className="roadmap-header">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-xs font-bold uppercase tracking-wider text-[#2D7270]">
              PASSO A PASSO
            </span>
          </div>
          <h2>
        ...
        <div className="roadmap-serpentina-wrapper !max-w-none hidden lg:block overflow-x-auto pb-6">
          ...
          >
            ...
            <line
              x1="50" y1="125" x2="1050" y2="125"
              stroke="#2D7270" strokeWidth="2" strokeDasharray="5 5" strokeOpacity="0.4"
            />
