      ...
      <div className="mkt-inner">
        ...
        <div className="mkt-left">
          ...
          <p className="mkt-body">
            A saúde bucal não é sazonal. É uma necessidade contínua,
            impulsionada por uma população em crescimento e uma conscientização
            cada vez maior sobre a importância estética e funcional da
            odontologia.
          </p>
          ...
          <ul className="mkt-list">
            <li className="mkt-item">
              ...
              <div>
                <strong>214 milhões de pessoas</strong> fazem do Brasil o 2º
                maior mercado odontológico do mundo, atrás só dos EUA.
              </div>
            </li>
            <li className="mkt-item">
              <div className="mkt-check">
            ...
            <li className="mkt-item">
              ...
              <div>
                Com <strong>+100 mil implantes por ano</strong>, a
                OdontoCompany captura o segmento de maior ticket do setor.
              </div>
            </li>
            <li className="mkt-item">
              <div className="mkt-check">
              ...
              <div>
                Você <strong>não precisa ser dentista</strong>, o modelo foi
                desenhado para gestores e investidores.
              </div>
            </li>
          </ul>
        </div>
        ...
        <div className="mkt-grid">
          <div className="mkt-card">
            ...
            <div className="mkt-card-label">
              UNIDADES EM TODOS OS ESTADOS DO BRASIL
            </div>
          </div>
          ...
          <div className="mkt-card">
            ...
            <div className="mkt-card-label">
              DENTISTAS INSCRITOS NA PLATAFORMA
            </div>
          </div>
        </div>
      </div>
